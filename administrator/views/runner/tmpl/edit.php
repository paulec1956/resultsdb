...
<script type="text/javascript">
	...
	Joomla.submitbutton = function (task) {
		if (task == 'runner.cancel') {
			Joomla.submitform(task, document.getElementById('runner-form'));
		}
		else {
			
			if (task != 'runner.cancel' && document.formvalidator.isValid(document.id('runner-form'))) {
...
<form
	...
	method="post" enctype="multipart/form-data" name="adminForm" id="runner-form" class="form-validate form-horizontal">
